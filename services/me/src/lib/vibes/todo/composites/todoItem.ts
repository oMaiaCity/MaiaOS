/**
 * Todo Item Composite Component
 * Responsive using container queries - adapts from 256px to 1280px+
 * Composes multiple leaf elements: checkboxes, inputs, badges, buttons
 */

import type { CompositeConfig } from '../../../compositor/view/types'

export const todoItemComposite: CompositeConfig = {
	id: 'todo.composite.todoItem',
	container: {
		layout: 'flex',
