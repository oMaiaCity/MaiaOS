...
<div class="w-full h-full overflow-y-auto max-w-6xl mx-auto px-6 py-6 space-y-6">
  ...
  {:else if !isBetterAuthSignedIn}
    ...
    <div class="space-y-32 py-12">
      <!-- Hero Section -->
      <header class="text-center px-4 max-w-4xl mx-auto space-y-8">
        <div class="relative group max-w-4xl mx-auto mb-12">
          <div class="absolute -inset-2 bg-[#3D895A]/10 rounded-[3rem] blur-3xl group-hover:bg-[#3D895A]/20 transition-all duration-1000"></div>
          <div class="relative bg-white rounded-[3rem] overflow-hidden border-8 border-white shadow-2xl transition-transform duration-1000 hover:scale-[1.01]">
            <img
              src="/brand/images/maiacity-render2.png"
              alt="Maia City Capital Render"
              class="w-full h-auto aspect-video object-cover"
            />
            <!-- Centered Logo Overlay -->
            <div class="absolute inset-0 flex items-center justify-center pointer-events-none">
              <div class="relative flex items-center justify-center">
                <div class="absolute w-52 h-52 bg-white/60 rounded-full blur-3xl"></div>
                <div class="absolute w-44 h-44 bg-white/90 rounded-full shadow-2xl"></div>
                <img
                  src="/brand/MaiaCityWithText.svg"
                  alt="Maia City Logo"
                  class="relative z-10 w-full max-w-40 drop-shadow-[0_10px_10px_rgba(0,0,0,0.5)]"
                />
              </div>
            </div>
          </div>
        ...
        <div class="space-y-8">
          <div class="space-y-4">
            <h1 class="text-3xl md:text-5xl font-black text-[#1F4269] leading-[1.2] tracking-tighter max-w-2xl mx-auto text-balance">
              Can <span class="italic font-serif text-[#3D895A]">1,346,269 humans</span> cooperate to build 10x greater cities from the ground up?
            </h1>
            <p class="text-xl md:text-2xl font-bold text-[#1F4269] opacity-90">
              In exactly <span class="text-[#3D895A]">{diffDays.toLocaleString()} days</span>, on March 21 2042, we will find out.
            </p>
          </div>

          <p class="text-lg text-slate-600 font-medium max-w-2xl mx-auto leading-relaxed pt-2">
      ...
      <section class="max-w-4xl mx-auto px-4 py-16 bg-[#F5F1CE]/50 rounded-4xl border border-[#3D895A]/10">
        ...
        <div class="grid md:grid-cols-2 gap-8 max-w-5xl mx-auto">
          ...
          <div class="p-8 rounded-[2.5rem] bg-white border border-[#3D895A]/10 hover:border-[#3D895A]/30 transition-all shadow-sm hover:shadow-xl group">
            <div class="flex items-start gap-6">
              ...
              <div class="space-y-3">
                <h4 class="text-xs font-black text-[#3D895A] uppercase tracking-widest text-balance">Phase 1: Digital Agent Assets</h4>
                <h5 class="text-xl font-bold text-[#1F4269] leading-tight text-balance">MaiaOS: Own Your Value</h5>
                <p class="text-slate-600 text-sm leading-relaxed">
                  The road to sovereignty starts with digital assets. Build voice-enabled "Vibes" with Maia AI and 
                  own them as income-generating agents. Replace labor with automated value that scales with the city.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="p-8 rounded-[2.5rem] bg-white border border-[#3D895A]/10 hover:border-[#3D895A]/30 transition-all shadow-sm hover:shadow-xl group">
            <div class="flex items-start gap-6">
              ...
              <div class="space-y-3">
                <h4 class="text-xs font-black text-[#3D895A] uppercase tracking-widest text-balance">Phase 2: Physical & Tech Assets</h4>
                <h5 class="text-xl font-bold text-[#1F4269] leading-tight text-balance">Maia Village: The Innovation Hub</h5>
                <p class="text-slate-600 text-sm leading-relaxed">
                  The primary breeding ground for physical invention. Own a piece of the startups building 
                  the city's backbone: autonomous drones, robotics, underground transport networks, 
                  and dome housing—all united at our first physical site near the Mediterranean.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="p-8 rounded-[2.5rem] bg-white border border-[#3D895A]/10 hover:border-[#3D895A]/30 transition-all shadow-sm hover:shadow-xl group">
            <div class="flex items-start gap-6">
              ...
              <div class="space-y-3">
                <h4 class="text-xs font-black text-[#3D895A] uppercase tracking-widest text-balance">Phase 3: Real Estate Assets</h4>
                <h5 class="text-xl font-bold text-[#1F4269] leading-tight text-balance">The Democratic Simulation</h5>
                <p class="text-slate-600 text-sm leading-relaxed">
                  Design the city alongside its future humans in a 100% 3D simulation. Together, we model 
                  resource flows and test a new democratic OS, while securing actual real estate purchase 
                  options to anchor the vision in physical land.
                </p>
              </div>
            </div>
          </div>
          ...
          <div class="p-8 rounded-[2.5rem] bg-white border border-[#3D895A]/10 hover:border-[#3D895A]/30 transition-all shadow-sm hover:shadow-xl group">
            <div class="flex items-start gap-6">
              ...
              <div class="space-y-3">
                ...
                <h5 class="text-xl font-bold text-[#1F4269] leading-tight text-balance">Manifesting the City Economy</h5>
                <p class="text-slate-600 text-sm leading-relaxed text-balance">
                  The final transition where every Sovereign Human around the world owns a direct piece 
                  of the overall Maia City Economy. A city-scale engine of abundance where your participation 
                  anchors you in the wealth of a new planetary capital.
                </p>
              </div>
            </div>
          </div>
      ...
      <section class="text-center max-w-5xl mx-auto space-y-16 px-4">
        <div class="space-y-4">
          <div class="inline-block px-4 py-1 bg-[#F5F1CE] text-[#1F4269] rounded-full text-xs font-bold uppercase tracking-widest border border-[#3D895A]/20">
            The Vision
          </div>
        ...
        <div class="pt-8">
          <button
            ...
            class="px-16 py-6 bg-[#3D895A] hover:bg-[#1F4269] text-white font-black text-2xl rounded-full transition-all shadow-[0_20px_50px_rgba(61,137,90,0.3)] hover:scale-105 active:scale-95 flex items-center justify-center gap-4 mx-auto group w-full max-w-md"
          >
  ...
  {:else if me && me.$isLoaded}
    <!-- Welcome Section -->
    <header class="text-center pb-4 py-12">
      <!-- Profile Image -->
      {#if profileImage}
