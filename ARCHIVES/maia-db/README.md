...
Shared Jazz data schemas, utilities, computed fields system, migrations, and group utilities for the MaiaCity monorepo.
...
This package is part of the MaiaCity monorepo and uses workspace dependencies:
