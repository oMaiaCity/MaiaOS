/**
 * Hominio Provider Injection Script
 * This script is injected into web pages to provide the window.hominio API
 * It communicates with the extension's content script via postMessage
 */
(function() {
  'use strict';
