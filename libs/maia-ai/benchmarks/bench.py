...
Start the server:  from repo root, `bun run dev:moai` (or `cd libs/maia-ai && uv run python -m maia_ai.server`)
Then:              `cd libs/maia-ai && uv run python benchmarks/bench.py`
