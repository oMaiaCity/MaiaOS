...
export class DBAdapter {
	 ...
	 */
	async read(_schema, _key, _keys, _filter) {
	 ...
	 */
	async update(_schema, _id, _data) {
	 ...
	 */
	async seed(_configs, _schemas, _data) {
