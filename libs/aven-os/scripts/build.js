...
const buildLog = createLogger('aven-os')
...
async function main() {
	await build('libs/aven-os/client/index.js', 'aven-client.mjs', 'browser', {
	...
	if (!existsSync(wasmSource)) {
		buildLog.error('[aven-os] Missing pglite.wasm at', wasmSource)
		process.exit(1)
	}
