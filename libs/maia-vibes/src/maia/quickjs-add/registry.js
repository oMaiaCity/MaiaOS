...
const base = 'quickjs-add'
const brand = annotateMaiaConfig(maiacityBrand, 'brand/maiacity.style.maia')
const vibe = annotateMaiaConfig(quickjsAddVibe, `${base}/manifest.vibe.maia`)
...
const layoutQuickjsAddActorA = annotateMaiaConfig(
	layoutQuickjsAddActor,
	`${base}/layout-quickjs-add/actor.maia`,
)
const layoutQuickjsAddContextA = annotateMaiaConfig(
	layoutQuickjsAddContext,
	`${base}/layout-quickjs-add/context.maia`,
)
const layoutQuickjsAddInterfaceA = annotateMaiaConfig(
	layoutQuickjsAddInterface,
	`${base}/layout-quickjs-add/interface.maia`,
)
...
export const QuickjsAddVibeRegistry = {
	...
	actors: {
		...
		[layoutQuickjsAddActorA.$id]: layoutQuickjsAddActorA,
	...
	contexts: {
		...
		[layoutQuickjsAddContextA.$id]: layoutQuickjsAddContextA,
	...
	interfaces: {
		...
		[layoutQuickjsAddInterfaceA.$id]: layoutQuickjsAddInterfaceA,
