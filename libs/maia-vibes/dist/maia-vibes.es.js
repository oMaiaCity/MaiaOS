...
async function getAllVibeRegistries() {
  ...
  try {
    const { TodosVibeRegistry: TodosVibeRegistry2 } = await Promise.resolve().then(() => registry$1);
