...
const schema = {
  $factory: 'co_z123...',  // Will be resolved!
  properties: {
...
- Implementation: `libs/maia-factories/src/validation.engine.js`
- Helper functions: `libs/maia-factories/src/validation.helper.js`
- Error formatting: `libs/maia-factories/src/validation.helper.js` (formatValidationErrors)
- Schema validation toggle: `libs/maia-factories/src/validation.helper.js` (withSchemaValidationDisabled)
