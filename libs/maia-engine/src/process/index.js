...
import { readStore, resolveFactoryFromCoValue, resolveToCoId } from '@MaiaOS/db/resolve-helpers'
...
export class ProcessEngine {
	...
	async _getActorConfigFromDb(actorCoId) {
		...
		try {
			const factoryCoId = await resolveFactoryFromCoValue(this.dataEngine?.peer, actorCoId)
