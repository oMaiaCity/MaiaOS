...
export class StyleEngine {
	...
	async getStyleSheets(actorConfig, actorId = null) {
		...
		const brandSchemaCoId = await resolveFactoryFromCoValue(this.dataEngine?.peer, brandResolved)
		...
		if (styleCoId) {
			...
			const styleSchemaCoId = await resolveFactoryFromCoValue(this.dataEngine?.peer, styleResolved)
