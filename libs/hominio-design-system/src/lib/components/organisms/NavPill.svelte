<script>
	...
	import GlassIconButton from '../atoms/GlassIconButton.svelte';
	import CallButton from '../atoms/CallButton.svelte';
	import ProfileAvatar from '../atoms/ProfileAvatar.svelte';
...
-->
<div class={cx(glassPillBase, isFixed && glassPillNav, darkThemeOverride)}>
	<!-- Left: Notifications -->
